    ...
    >
      ...
      >
        ...
        <div className="mb-5 flex items-center justify-between">
          <h2 className="text-[16px] font-medium text-[#1a1a1a]">Нова категорія</h2>
          <button
            type="button"
            onClick={onClose}
...
function CategoryRow({ category, isSystem, onEdit }: CategoryRowProps) {
  return (
...
export default function TransactionCategoriesPage() {
  const { categories, isLoading, error, createCategory, updateCategory } =
  ...
  return (
    <div>
      ...
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-[18px] font-medium text-[#1a1a1a]">Категорії транзакцій</h1>
